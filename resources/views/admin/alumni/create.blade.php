...
<x-layout-admin>
    ...
    <x-slot name="header">
        <x-admin.header>Tambah Alumni</x-admin.header>
        ...
        <div class="bg-white rounded-lg sm:rounded-xl shadow-md overflow-hidden">
            ...
            <div class="px-4 sm:px-6 lg:px-8 py-4 sm:py-6 border-b border-gray-200 bg-gray-50">
                <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
                    <div>
                        <h1 class="text-xl sm:text-2xl font-bold text-gray-900">Tambah Data Alumni</h1>
                        <p class="text-sm sm:text-base text-gray-600 mt-1">
                            Lengkapi formulir di bawah untuk menambah alumni baru
                        </p>
                    </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
                        ...
                        <select name="id_study" id="id_study" 
                            ...
                            @foreach($prodi as $prodis)
                                <option value="{{ $prodis->id_study }}" 
                                    {{ old('id_study') == $prodis->id_study ? 'selected' : '' }}>
                    ...
                    <div class="space-y-1 sm:space-y-2">
                        ...
                        <select name="graduation_year" id="graduation_year" 
                            ...
                            @for($y = date('Y'); $y >= 1990; $y--)
                                <option value="{{ $y }}" 
                                    {{ old('graduation_year') == $y ? 'selected' : '' }}>
                                    {{ $y }}
                                </option>
                            @endfor
                        </select>
                    ...
                    <div class="space-y-1 sm:space-y-2">
                        ...
                        <select name="status" id="status" 
                            ...
                            <option value="bekerja" {{ old('status') == 'bekerja' ? 'selected' : '' }}>
                                Bekerja
                            </option>
                            <option value="tidak bekerja" {{ old('status') == 'tidak bekerja' ? 'selected' : '' }}>
                                Tidak Bekerja
                            </option>
                            <option value="melanjutkan studi" {{ old('status') == 'melanjutkan studi' ? 'selected' : '' }}>
                                Melanjutkan Studi
                            </option>
                            <option value="berwiraswasta" {{ old('status') == 'berwiraswasta' ? 'selected' : '' }}>
                                Berwiraswasta
                            </option>
                            <option value="sedang mencari kerja" {{ old('status') == 'sedang mencari kerja' ? 'selected' : '' }}>
