...
<x-layout-admin>
    ...
    <x-slot name="header">
        <x-admin.header>Tambah Kategori</x-admin.header>
    ...
    <div class="px-3 sm:px-4 lg:px-6 max-w-7xl mx-auto py-4 sm:py-6">
            ...
            <form action="{{ route('admin.questionnaire.category.store', $periode->id_periode) }}" method="POST" class="px-4 sm:px-6 py-4 sm:py-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6 mb-4 sm:mb-6">
                    ...
                    <div>
                        ...
                        <select name="for_type" 
                                ...
                                required
                                class="w-full px-3 sm:px-4 py-2 sm:py-3 text-sm sm:text-base border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors duration-200">
                            <option value="both" {{ old('for_type', request('for_type', 'both')) == 'both' ? 'selected' : '' }}>
                                Alumni & Perusahaan
                            </option>
                            <option value="alumni" {{ old('for_type', request('for_type')) == 'alumni' ? 'selected' : '' }}>
                                Alumni Saja
                            </option>
                            <option value="company" {{ old('for_type', request('for_type')) == 'company' ? 'selected' : '' }}>
                                Perusahaan Saja
                            </option>
                        </select>
                        @error('for_type')
                    ...
                    <div class="bg-gray-50 rounded-lg p-3 sm:p-4 border border-gray-200">
                        <div class="flex items-start mb-3">
                            <input type="checkbox" 
                                   ...
                                   value="1" 
                                   {{ old('is_status_dependent') ? 'checked' : '' }}
                        ...
                        <div id="alumni-status-options" class="mt-4 {{ old('is_status_dependent') ? '' : 'hidden' }}">
                ...
                <div class="bg-blue-50 border border-blue-200 rounded-lg p-3 sm:p-4 mb-4 sm:mb-6">
                    <div class="flex items-start">
                        ...
                        <div>
                            <h4 class="text-sm font-medium text-blue-800 mb-1">Panduan Membuat Kategori</h4>
                ...
                <div class="bg-gray-50 rounded-lg p-3 sm:p-4 border-l-4 border-blue-500">
                    <div class="flex flex-col sm:flex-row sm:items-center justify-between mb-2 space-y-2 sm:space-y-0">
                        ...
                        <div class="flex items-center space-x-2">
                            ...
                            <span id="preview-target" class="inline-flex items-center px-2 py-1 rounded-full text-xs font-medium bg-purple-100 text-purple-800">
        ...
        <div class="bg-white rounded-lg sm:rounded-xl shadow-md border border-gray-200 mt-4 sm:mt-6">
            <div class="px-4 sm:px-6 py-4 sm:py-6">
                <h3 class="text-base sm:text-lg font-semibold text-gray-800 flex items-center mb-4">
                    <i class="fas fa-rocket mr-2 text-purple-600"></i>
                    Template Kategori Cepat
                </h3>
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-4">
                    <button type="button" onclick="fillTemplate('Data Pribadi', 1, 'alumni')" 
                            class="p-3 sm:p-4 bg-blue-50 border border-blue-200 rounded-lg hover:bg-blue-100 transition-colors duration-200 text-left">
                        <div class="flex items-center mb-2">
                            <i class="fas fa-user text-blue-600 mr-2"></i>
                            <span class="text-sm font-medium text-blue-800">Data Pribadi</span>
                        </div>
                        <p class="text-xs text-blue-600">Untuk alumni - informasi personal</p>
                    </button>
                    
                    <button type="button" onclick="fillTemplate('Riwayat Pendidikan', 2, 'alumni')" 
                            class="p-3 sm:p-4 bg-green-50 border border-green-200 rounded-lg hover:bg-green-100 transition-colors duration-200 text-left">
                        <div class="flex items-center mb-2">
                            <i class="fas fa-graduation-cap text-green-600 mr-2"></i>
                            <span class="text-sm font-medium text-green-800">Riwayat Pendidikan</span>
                        </div>
                        <p class="text-xs text-green-600">Untuk alumni - latar belakang pendidikan</p>
                    </button>
                    
                    <button type="button" onclick="fillTemplate('Penilaian Alumni', 1, 'company')" 
                            class="p-3 sm:p-4 bg-orange-50 border border-orange-200 rounded-lg hover:bg-orange-100 transition-colors duration-200 text-left">
                        <div class="flex items-center mb-2">
                            <i class="fas fa-building text-orange-600 mr-2"></i>
                            <span class="text-sm font-medium text-orange-800">Penilaian Alumni</span>
                        </div>
                        <p class="text-xs text-orange-600">Untuk perusahaan - evaluasi kinerja</p>
                    </button>
                </div>
            </div>
        </div>
    ...
    function fillTemplate(name, order, forType) {
        ...
        document.getElementById('order').dispatchEvent(new Event('input'));
        document.getElementById('for_type').dispatchEvent(new Event('change'));
