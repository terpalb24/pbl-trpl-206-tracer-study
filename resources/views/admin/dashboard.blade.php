    ...
    <main class="flex-grow p-4 md:p-6 overflow-y-auto" id="main-content">
            ...
            <div class="relative">
                <div class="flex items-center bg-blue-900 text-white rounded-full px-4 py-2 cursor-pointer gap-3" id="profile-toggle">
                    ...
                    <div class="text-left hidden sm:block">
                        <p class="text-sm text-gray-300 leading-none">Admin</p>
                    </div>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6 mb-6">
            <div class="p-4 bg-gradient-to-r from-white via-sky-100 to-orange-300 rounded shadow">
                <div class="font-semibold">Selamat Datang Administrator!</div>
            </div>
            <div class="flex items-center p-4 bg-blue-950 text-white rounded shadow gap-4">
            ...
            <div class="flex items-center p-4 bg-orange-500 text-white rounded shadow gap-4 sm:col-span-2 lg:col-span-1">
