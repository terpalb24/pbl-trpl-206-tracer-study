...
<head>
    <meta charset="UTF-8">
    <title>Verifikasi Email Alumni</title>
    ...
    <div style="max-width: 480px; margin: 40px auto; background: #fff; border-radius: 12px; box-shadow: 0 4px 16px #dbeafe; padding: 32px 28px;">
        ...
        <div style="margin-top: 24px;">
            ...
            <div style="text-align: center; margin: 32px 0;">
                <a href="{{ url('/alumni/verify-email/' . $token) }}" style="background: linear-gradient(90deg,#0ea5e9,#0e7490); color: #fff; padding: 12px 36px; border-radius: 8px; text-decoration: none; font-weight: bold; font-size: 1rem; box-shadow: 0 2px 8px #bae6fd;">
                    Verifikasi Email
                </a>
            </div>
            ...
            <div style="background: #f1f5f9; color: #0e7490; word-break: break-all; padding: 10px 14px; border-radius: 6px; font-size: 13px; margin-bottom: 18px;">
                {{ url('/alumni/verify-email/' . $token) }}
            </div>
            <p style="color: #64748b; font-size: 13px; margin-top: 32px; text-align: left;">
                Link ini berlaku selama 30 menit.<br>
                Jika Anda tidak meminta verifikasi ini, abaikan email ini.<br>
                Terima kasih.<br>
