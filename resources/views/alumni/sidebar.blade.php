<a href="{{ route('dashboard.alumni') }}" class="flex items-center gap-3 px-2 py-2 rounded hover:bg-blue-800 transition {{ request()->routeIs('dashboard.alumni') ? 'bg-blue-800' : '' }}">
            ...
            <a href="{{ route('alumni.job-history.index') }}" class="flex items-center gap-3 px-2 py-2 rounded hover:bg-blue-800 transition {{ request()->routeIs('alumni.questionnaire.results') ? 'bg-blue-800' : '' }}">
